...
<font size="9px"> <em>Normal mode of vibration: a vibration in which all the nuclei undergo <b>harmonic motion</b>, have the same <div> <img src="https://render.githubusercontent.com/render/math?math=\nu_{vib}"> </div> and move in phase but generally with **differrent amplitudes** </em> </font> 
